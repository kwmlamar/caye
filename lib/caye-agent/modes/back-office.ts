...
export function buildBackOfficeSystemPrompt(args: {
  ...
  return [
    ...
    '',
    `  Low-risk WRITE tools (execute immediately, no confirmation needed):`,
    ...
    `- For SENDING messages to customers, quoting customers, confirming bookings, or any customer-FACING action — be honest: those tools land in the next slice. Offer to take it on the moment they exist. Don't apologize repeatedly, don't list reasons. Acknowledge cleanly and move on.`,
