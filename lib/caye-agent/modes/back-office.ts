...
export function buildBackOfficeSystemPrompt(args: {
  ...
  lines.push(
    ...
    `    • recover_outreach_operations — use when ${speaker} authorizes recovery toward the outreach target. It inspects pause provenance and only resumes an owner-created pause; it never overrides the bounce safety stop or an unknown pause. It runs permitted sourcing/autosend work and returns the actual outcome.`,
