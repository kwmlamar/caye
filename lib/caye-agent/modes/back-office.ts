...
export function buildBackOfficeSystemPrompt(args: {
  ...
  return [
    ...
    `- For things you DON'T have a tool for yet (customer lookups, sending replies, send_quote, confirm_booking, etc.) — be honest: those tools are landing this week. Offer to take it on the moment they are. Don't apologize repeatedly, don't list reasons. Acknowledge cleanly and move on.`,
