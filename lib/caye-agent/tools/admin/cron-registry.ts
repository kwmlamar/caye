...
import { runJobSearchFollowupSweep } from '@/app/api/caye/job-search-followup-sweep/route'
...
> = {
  ...
  'job-search-followup-sweep': { label: 'Flag applications gone quiet for a check-in and detect ghosting (founder-only, no sending)', run: runJobSearchFollowupSweep },
