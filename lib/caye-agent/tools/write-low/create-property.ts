...
export const createPropertyTool: Tool<Input> = {
  ...
  description: 'Create a persistent physical-property record in the current workspace from founder Caye Direct. This records a place Caye should understand over time; it does not authorize any physical work or device control.',
  risk: 'low',
  roles: ['founder'],
  modes: ['back-office'],
