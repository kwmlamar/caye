...
type StructuralSemanticKey = 'first_name' | 'last_name' | 'email' | 'phone' | 'resume' | 'cover_letter' | 'linkedin'

const PATTERNS: [HighRiskSemanticKey | StructuralSemanticKey, RegExp][] = [
