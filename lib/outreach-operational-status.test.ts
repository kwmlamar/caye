...
describe('authoritative outreach explanation', () => {
  ...
  it('reports cap', () => expect(explainNoOutreach(state({ sendsToday: { sent: 0, dailyLimit: 50, remaining: 0 } }))).toMatch(/limit/))
  ...
  it('returns null after successful outreach', () => expect(explainNoOutreach(state({ sendsToday: { sent: 5, dailyLimit: 50, remaining: 45 } }))).toBeNull())
