...
export function buildOwnerOnboardingObservation(input) {
  ...
  return {
    ...
    // Onboarding is an explicit owner instruction in the canonical authority
    // hierarchy. Provenance remains onboarding-specific below.
    ...
    // The canonical pipeline uses created_at as observed_at for temporal
    // resolution, so historical backfills retain their original event time.
